...
class TestAPIIntegration:
    ...
    def test_complete_user_registration_flow(self):
        ...
        assert result["message"] == "User registered successfully. Check your email for activation code."
    ...
    def test_duplicate_registration_security(self):
        ...
        assert response2.json()["message"] == "User registered successfully. Check your email for activation code."
    ...
    def test_api_error_responses(self):
        ...
        # Test 1: Invalid JSON
        response = self.client.post("/register", content="invalid json", headers={"content-type": "application/json"})
        ...
        response = self.client.post("/register", json={"email": "invalid-email", "password": "pass"})
        assert response.status_code == 422
    ...
    def test_one_minute_expiration_requirement(self):
        ...
        assert time_difference < 1, f"Expiration should be 1 minute, but difference is {time_difference} seconds"
